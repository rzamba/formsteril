$(function(){
	...
	$("a#submit").click(function(){
        ...
        mailHandlerURL = "http://www.formsteril.com.br/apps/contato/";
		$.ajax({
			type: "POST",
			url: mailHandlerURL,
			data: dataString,
			success: function(){
				$('.error').hide();
				$('form#contact-form').clearForm();
				$('#contact_form').html("<div class='download-box'>Recebemos a sua mensagem!</div>")
					.append("<br><label for='message'><b>Em breve entraremos em contato.</b></label>")
					.hide()
					.fadeIn(1500, function(){
						$('#contact_form').append("<br><br><a id='back' onclick='window.location.reload(); return false;' class='button'>retornar</a>");
					});
			}
		});
